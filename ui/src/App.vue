              ...
              <div class="sidebar-logo">
                ...
                <div class="auth-nav" v-if="!authStore.sessionLoading">
                  <template v-if="!authStore.isAuthenticated">
                    <a-button block @click="uiStore.signInModalVisible = true">
                      <user-outlined /> Sign In
                    </a-button>
                    <a-button block ghost class="mt-2" @click="uiStore.registerModalVisible = true">
                      <star-outlined /> Sign Up
                    </a-button>
                  </template>
                </div>
              </div>
